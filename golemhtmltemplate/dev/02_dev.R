...
golem::add_module( name = "name_of_module3" ) # Name of the module
golem::add_module( name = "name_of_module4" ) # Name of the module
golem::add_module( name = "name_of_module5" ) # Name of the module
...
## Vignette ----
usethis::use_vignette("golemhtmltemplate")
